...
setGeneric("cmds", function(x, k=2, logscale=TRUE, mc.cores=1) standardGeneric("cmds"))
setGeneric("cmdsFit", function(d, k=2, type='classic') standardGeneric("cmdsFit"))
setGeneric("ssdCoverage", function(x, mc.cores=1) standardGeneric("ssdCoverage"))
setGeneric("giniCoverage", function(sample, mc.cores=1, mk.plot=FALSE, seqName='missing', species="missing", chrLengths='missing') standardGeneric("giniCoverage"))
...
setGeneric("enrichedRegions", function(sample1, sample2, regions, minReads=10, pvalFilter=0.05, exact=FALSE, p.adjust.method='none', twoTailed=FALSE, mc.cores=1) standardGeneric("enrichedRegions"))
