...
setGeneric("plotMeanCoverage", function(cover, x, upstreambp=1000, downstreambp=5000, startpos='start_position', endpos='end_position', normalize=FALSE, main='', xlab='(bp)', ylab='Average coverage', ...) standardGeneric("plotMeanCoverage")) 
